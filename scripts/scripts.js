...
new TypeIt("#teks1", {
  strings: ["Hari ini, aku langitkan semua doa terbaik aku untuk kamu.", "Semoga hal-hal yang membuat kamu tidak make sense itu turut menjadi alasan kamu agar untuk tetap bangkit.", "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada.", "Semoga hari-hari kamu selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Amelia! Selamat ulang tahun yang ke 789 tahun, sahabatku. Semoga Allah selalu melimpahkan rahmat dan keberkahan dalam perjalananmu, memberikan kesehatan, kebahagiaan, serta rezeki yang halal dan melimpah.", " Semoga setiap langkah yang kau ambil selalu dalam lindungan-Nya, dan segala cita-citamu dimudahkan untuk tercapai.", " Semoga Allah menjadikanmu pribadi yang lebih baik setiap harinya, serta diberikan umur yang berkah dan bermanfaat.", " Aamiin ya Rabbal ‘alamin.", " Nikmati hari spesialmu dengan penuh syukur dan kebahagiaan!", " ", "barakallah fi umrik, terima kasih sudah bertahan sampai sejauh ini.", " ", "- Wish all you the best", " ", "amelia"],
  startDelay: 2000,
  speed: 25,
  waitUntilVisible: true
}).go();
